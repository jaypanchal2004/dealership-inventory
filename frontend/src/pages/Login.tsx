    ...
    <div className="min-h-screen flex items-center justify-center bg-[#1e293b] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-slate-400 mt-1">Quality rides, honest prices</p>
        </div>
        ...
        >
          <h2 className="text-xl font-semibold mb-6 text-slate-800">Log In</h2>
          ...
          <p className="text-sm text-slate-600 mt-4 text-center">
            ...
            <Link to="/register" className="text-[#d97706] font-medium hover:underline">
              Register
            </Link>
          </p>
        </form>
