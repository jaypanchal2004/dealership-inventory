...
**[Live Demo](https://dealership-inventory.vercel.app/login)**

(The backend is hosted on Render's free tier. If the API has been inactive, the very first login/data request may take 30-50 seconds to wake the server. If it times out, simply click submit again!)
